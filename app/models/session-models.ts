...
export class RecordedSet {
   ...
   */
  constructor();
  constructor(repsCompleted: number, rpe: number | undefined, completionDateTime: OffsetDateTime);
  constructor(repsCompleted?: number, rpe?: number, completionDateTime?: OffsetDateTime) {
  ...
  static fromPOJO(pojo: DeepOmit<RecordedSetPOJO, 'type'>): RecordedSet {
    return new RecordedSet(pojo.repsCompleted, pojo.rpe, pojo.completionDateTime);
  }
