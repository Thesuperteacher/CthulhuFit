  ...
  return (
    ...
    >
      <ExerciseCard
        ...
        onOpenDetails={() => setPreviousDialogOpen(true)} // Default to showing history/details
        onOpenMenu={() => setMenuVisible(true)}
        // We can pass performance history from previousRecordedExercises
        previousPerformance={props.previousRecordedExercises.length > 0 ? "History available" : undefined}
      >
        {props.children}
      </ExerciseCard>

      {/* Hidden original interactive buttons block, now handled by card menu options */}
      <View style={{ display: 'none' }}>{interactiveButtons}</View>
