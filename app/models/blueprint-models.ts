...
export interface CardioExerciseBlueprintPOJO {
  ...
  userExerciseId?: string | undefined;
}
export class CardioExerciseBlueprint {
  ...
  readonly catalogExerciseId?: string | undefined;
  readonly userExerciseId?: string | undefined;
  ...
  equals(other: ExerciseBlueprint | ExerciseBlueprintPOJO | undefined) {
    ...
    return (
      ...
      this.catalogExerciseId === other.catalogExerciseId &&
      this.userExerciseId === other.userExerciseId
    );
  }
  ...
  toPOJO(): CardioExerciseBlueprintPOJO {
    return {
      ...
      notes: this.notes,
      link: this.link,
      catalogExerciseId: this.catalogExerciseId,
